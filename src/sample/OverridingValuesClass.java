 ...
 */
    ...
    protected static boolean OverridePlayer(Player nut , Player defaultObject   ){
        ...
        if(OverridePlane(nut , defaultObject    )) {
            ...
            //temp = "buttonFire";
            nut.setButtonFire(defaultObject.getButtonFire());

            //temp = "buttonAltFire";
            nut.setButtonAltFire(defaultObject.getButtonAltFire());
    ...
    *  @param nut given a SolidObject or child read from the filereader
     ...
     *  @return false if either nut or filereader was not initalized
     */
    protected static boolean OverrideAssembler(Assembler nut , FileReader fileReader   ){

        if(OverrideBuilding(nut , fileReader    )){
     ...
     *  @return false if either nut or filereader was not initalized
     */
    protected static boolean OverrideAssembler(Assembler nut , Assembler defaultObject   ){

        if(OverrideBuilding(nut , defaultObject    )){
     ...
     *  @return false if either nut or filereader was not initalized
     */
    protected static  boolean OverrideConveyor(Conveyor nut , FileReader fileReader   ){
     ...
     *  @return false if either nut or filereader was not initalized
     */
    protected static  boolean OverrideConveyor(Conveyor nut , Conveyor defaultObject){
     ...
     *  @return false if either nut or filereader was not initalized
     */
    protected static  boolean OverrideEightBuilding(EightBuilding nut , FileReader fileReader   ){
     ...
     *  @return false if either nut or filereader was not initalized
     */
    protected static  boolean  OverrideEightBuilding(EightBuilding nut , EightBuilding defaultObject){
     ...
     *  @return false if either nut or filereader was not initalized
     */
    protected static  boolean OverrideMinerBuilding(MinerBuilding nut , FileReader fileReader   ){
        String temp = "";
        if(OverrideBuilding(nut , fileReader    )){
     ...
     *  @return false if either nut or filereader was not initalized
     */
    protected static  boolean OverrideMinerBuilding(MinerBuilding nut , MinerBuilding defaultObject   ){

        if(OverrideBuilding(nut , defaultObject    )){

            nut.setDefaultMiningSpeed(defaultObject.getDefaultMiningSpeed());
     ...
     *  @return false if either nut or filereader was not initalized
     */
    protected static  boolean OverrideNinthBuilding(NinthBuilding nut , FileReader fileReader   ){
     ...
     *  @return false if either nut or filereader was not initalized
     */
    protected static  boolean OverrideNinthBuilding(NinthBuilding nut , NinthBuilding defaultObject   ){
     ...
     *  @return false if either nut or filereader was not initalized
     */
    protected static  boolean OverridePipe(Pipe nut , FileReader fileReader   ){
     ...
     *  @return false if either nut or filereader was not initalized
     */
    protected  static boolean OverridePipe(Pipe nut , Pipe defaultObject   ){
     ...
     *  @return false if either nut or filereader was not initalized
     */
    protected static  boolean OverrideSeventBuilding(SeventhBuilding nut , FileReader fileReader   ){
     ...
     *  @return false if either nut or filereader was not initalized
     */
    protected static  boolean OverrideSeventBuilding(SeventhBuilding nut , SeventhBuilding defaultObject   ){
     ...
     *  @return false if either nut or filereader was not initalized
     */
    protected static  boolean OVerrideSteamGenerator(SteamGenerator nut , FileReader fileReader   ){
     ...
     *  @return false if either nut or filereader was not initalized
     */
    protected static  boolean OVerrideSteamGenerator(SteamGenerator nut , SteamGenerator defaultObject   ){
     ...
     *  @return false if either nut or filereader was not initalized
     */
    protected static  boolean OVerrideElectricPole(ElectricPole nut , FileReader fileReader   ){
     ...
     *  @return false if either nut or filereader was not initalized
     */
    protected static  boolean OVerrideElectricPole(ElectricPole nut , ElectricPole defaultObject   ){
    ...
    protected static void OverrideGameCmds(FileReader file
                                ,int pelletCount, boolean gamePaused,
                                  ...
                                  int Keycmd_PauseGame, int Keycmd_StepRound, int Keycmd_IncreaseSpeed, int Keycmd_DecreaseSpeed, int Keycmd_repopulateFood, int Keycmd_ToggleGraphics,
                                  int roundDuration, int initPopulationSize
