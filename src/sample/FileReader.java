...
public class FileReader {
     ...
     * @return true when the function was able to successfully override the parameter
     * @param FileContents the string of the file contents
     */
     ...
     * @param VariableName  te variable name of that is the cooresponding item to find it with
     */
